...
class PillBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String next_label = 'Today', prev_label = 'Today';
        ...
        body: StreamBuilder(
            ...
            builder: (context, snapshot) {
              ...
              if (snapshot.hasData) {
                ...
                if (dif1 >= 0) {
                  next_hour = getHour(first_time).toString().padLeft(2, '0');
                  next_minute =
                      getMinutes(first_time).toString().padLeft(2, '0');
                  prev_hour = getHour(second_time).toString().padLeft(2, '0');
                  prev_min = getMinutes(second_time).toString().padLeft(2, '0');
                  next_label = 'Today';
                  prev_label = 'Yesterday';
                } else if (dif2 >= 0) {
                  next_hour = getHour(second_time).toString().padLeft(2, '0');
                  next_minute =
                      getMinutes(second_time).toString().padLeft(2, '0');
                  prev_hour = getHour(first_time).toString().padLeft(2, '0');
                  prev_min = getMinutes(first_time).toString().padLeft(2, '0');
                  next_label = 'Today';
                  prev_label = 'Today';
                } else {
                  next_hour = getHour(first_time).toString().padLeft(2, '0');
                ...
                /*
          if(now_in_min==next_in_min){
            prev_in_minutes=next_in_min;
          }
          print('prev: $prev_in_minutes');
          */

                /****************send late message after 15 min + to monitor *********************/
                //if(now_in_min-prev_in_minutes==late1_time)
                //&& now_in_min-prev_in_minutes>=late1_time-1)
                //{
                try {
                  print('inside late1');
                ...
                //if(now_in_min-prev_in_minutes<=late2_time
                //& now_in_min-prev_in_minutes>late2_time-1)
                //{
                try {
                  print('inside late2');
                  final curr_status = data['notification']['taken_pill'];
                    ...
                    children: <Widget>[
                      Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            child: Text(
                              'Welcome to your Pill Tracker David!',
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(width: 10.0),
                          BoxCell(info: morning_cells[0]), //maybe add things
                          SizedBox(width: 10.0),
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(width: 10.0),
                          BoxCell(info: evening_cells[0]), //maybe add things
                          SizedBox(width: 10.0),
